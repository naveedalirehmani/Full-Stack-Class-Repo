                        ...
                        <ul className="pt-2 pb-4 space-y-1 text-sm">
                            ...
                            <li className="rounded-sm">
                                ...
                                >
                                    ...
                                    <span> <NavLink end style={(isActive)=>{
                                        return isActive ? {color:'black'} : {}
                                    }} to="/routes/nested/customhooks">custom Hooks </NavLink></span>
                                </a>
                            </li>
                            <li className="rounded-sm">
                                <a
                                ...
                                >
                                    ...
                                    <span> <NavLink end style={(isActive)=>{
                                        return isActive ? {color:'black'} : {}
                                    }} to="/routes/nested/useeffect">use Effect </NavLink></span>
                                </a>
                            </li>
                            <li className="rounded-sm">
                                <a
                                ...
                                >
                                    ...
                                    <span> <NavLink end NavLink style={(isActive)=>{
                                        return isActive ? {color:'black'} : {}
                            ...
                            <li className="rounded-sm">
                                ...
                                >
                                    ...
                                    <span> <NavLink end style={(isActive)=>{
                                        return isActive ? {color:'black'} : {}
                                    }} to="/routes/nested/usereducer">use Reducer </NavLink></span>
                                </a>
                            </li>
                            <li className="rounded-sm">
                                <a
                                ...
                                >
                                    ...
                                    <span> <NavLink end style={(isActive)=>{
                                        return isActive ? {color:'black'} : {}
                                    }} to="/routes/nested/rickandmorty">Rick and Morty </NavLink></span>
                                </a>
                            </li>
                            <li className="rounded-sm">
                                <a
